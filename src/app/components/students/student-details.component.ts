...
import {AttendanceSummary, Fee, MaktabClass, Student, Teacher} from '../models/all.models'; // correct path
...
export class StudentDetailsComponent implements OnInit {
  ...
  updateStudent() {
    ...
    formData.append(
      'student',
      new Blob([JSON.stringify(this.editingStudent)], {
  ...
  newEvaluationForm(id: number){
    if (!id) return;
    this.route.navigate(['/evaluations', 'new-form', id]);
  }
}
